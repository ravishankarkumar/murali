...
fn main() -> anyhow::Result<()> {
    ...
    let title_id = scene.add_tattva(
        Label::new("Arrow Primitive Showcase", 0.36)
    ...
    scene.add_tattva(
        Label::new("Up", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
    ...
    scene.add_tattva(
        Label::new("Right", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
    ...
    scene.add_tattva(
        Label::new("Diagonal", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
    ...
    scene.add_tattva(
        Label::new("Small", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
    ...
    let large_arrow = Arrow::with_default_tip(
        ...
        Vec2::new(4.5, 1.5),
        0.08,
        Vec4::new(0.7, 0.3, 1.0, 1.0),
    );
    scene.add_tattva(large_arrow, Vec3::ZERO);
    scene.add_tattva(
        Label::new("Large", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
    ...
    scene.add_tattva(
        Label::new("Wide Tip", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
    ...
    scene.add_tattva(
        Label::new("Narrow Tip", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
    ...
    scene.add_tattva(
        Label::new("Long Tip", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
        Vec3::new(2.0, 1.2, 0.0),
    );

    // Vector field pattern
    scene.add_tattva(
        Label::new("Vector Field Pattern", 0.14).with_color(Vec4::new(0.8, 0.8, 0.8, 1.0)),
