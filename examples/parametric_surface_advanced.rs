...
fn main() -> anyhow::Result<()> {
    ...
    .with_samples(40, 28)
    .with_color(Vec4::new(0.78, 0.82, 0.90, 1.0));

    scene.add_tattva(interesting, Vec3::new(0.0, -3.5, 0.0));

    scene.add_tattva(
        Label::new("Parametric Surface", 0.16)
            .with_color(Vec4::new(0.79, 0.83, 0.88, 1.0)),
