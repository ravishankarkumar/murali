...
fn main() -> anyhow::Result<()> {
    ...
    use murali::frontend::collection::storytelling::stepwise::model::{Transition, Direction};
    model.transitions.push(Transition {
        from: 3,
        to: 1,
        route: Some(vec![Direction::Up, Direction::Left, Direction::Left, Direction::Down]),
    });
    ...
    let sw_id = scene.add_tattva(sw, Vec3::new(-4.0, 0.0, 0.0));
