...
fn main() -> anyhow::Result<()> {
    ...
    let wavy_wireframe = ParametricSurface::new(
        (-PI, PI),
        (-PI, PI),
        |u, v| {
            let x = u;
    ...
    scene.add_tattva(
        Label::new("Wireframe Heat Map", 0.16)
    ...
    let sphere_solid_wire = ParametricSurface::new(
        (0.0, PI),
        (0.0, 2.0 * PI),
        |u, v| {
            let sin_u = u.sin();
    ...
    .with_color(Vec4::new(0.44, 0.84, 0.71, 0.6))
    .with_color_fn(|z| {
    ...
    scene.add_tattva(
        Label::new("Solid + Wireframe", 0.16)
            .with_color(Vec4::new(0.79, 0.83, 0.88, 1.0)),
        Vec3::new(4.0, -2.2, 0.0),
    );
    ...
    let torus_wireframe = ParametricSurface::new(
        (0.0, 2.0 * PI),
        (0.0, 2.0 * PI),
        |u, v| {
            let r = 0.4;
    ...
    scene.add_tattva(torus_wireframe, Vec3::new(0.0, -3.5, 0.0));

    scene.add_tattva(
        Label::new("Torus Rainbow Wireframe", 0.16)
            .with_color(Vec4::new(0.79, 0.83, 0.88, 1.0)),
