...
fn main() -> anyhow::Result<()> {
    ...
    let title_id = scene.add_tattva(
        Label::new("Graph On 2D Axes", 0.36).with_color(Vec4::new(0.97, 0.98, 0.99, 1.0)),
        Vec3::ZERO,
    );
    ...
    scene.add_tattva(
        Label::new("y = 0.08x^3 - 0.55x", 0.24).with_color(Vec4::new(0.37, 0.80, 0.97, 1.0)),
    ...
    scene.add_tattva(
        Label::new("x", 0.28).with_color(Vec4::new(0.93, 0.42, 0.37, 1.0)),
        Vec3::new(5.25, -0.18, 0.0),
    );

    scene.add_tattva(
        Label::new("y", 0.28).with_color(Vec4::new(0.37, 0.68, 0.91, 1.0)),
