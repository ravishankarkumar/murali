...
fn add_network_panel(
    ...
    scene.add_tattva(
        Label::new(title, 0.26).with_color(Vec4::new(0.95, 0.97, 0.99, 1.0)),
    ...
    scene.add_tattva(
        Label::new(caption, 0.18).with_color(Vec4::new(0.78, 0.82, 0.87, 1.0)),
        origin + Vec3::new(0.0, -2.35, 0.0),
    );
...
fn main() -> anyhow::Result<()> {
    ...
    scene.add_tattva(
        Label::new("Neural Network V2", 0.36).with_color(Vec4::new(0.97, 0.98, 0.99, 1.0)),
        Vec3::ZERO,
    );
