...
* `rendered_output/<artifact>/frames/<artifact>_00000.png`
* `rendered_output/<artifact>/frames/<artifact>_00001.png`
* `rendered_output/<artifact>/frames/<artifact>_00002.png`

If `ffmpeg` is missing, Murali still keeps these PNG frames and tells you where they were written.

Murali also lets you choose how aggressively those PNGs are compressed:

* `fast` — bigger files, faster exports
* `balanced` — a middle ground between speed and size
* `smallest` — smaller files, slower exports
