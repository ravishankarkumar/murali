...
If you are choosing between text systems for a real scene, start here and then read [Math](./math.md), [Animations](../animations.md), and [Examples](../examples/index.md).
...
- [Which API Should I Use?](../which-api-should-i-use.md)
